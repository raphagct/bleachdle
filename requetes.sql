...
INSERT INTO personnages (name, gender, age, race, affiliation, evolutive_forms, rank, introduction_arc, image) VALUES
    ...
    ('Kisuke Urahara', 'Homme', '300', 'Shinigami', 'Ville de Karakura', 'Bankai', 'Propriétaire d''un magasin', 'Prélude', 'assets/img/urahara'),
    ...
    ('Jūshirō Ukitake', 'Homme', '200', 'Shinigami', 'Gotei 13 (13ème division)', 'Bankai', 'Capitaine', 'Arc de la Soul Society', 'assets/img/jushiro'),
    ('Mayuri Kurotsuchi', 'Homme', '200', 'Shinigami', 'Gotei 13 (12ème division)', 'Bankai', 'Capitaine', 'Arc de la Soul Society', 'assets/img/mayuri'),
    ('Shinji Hirako', 'Homme', 'Unknown', 'Shinigami, Visored', 'Gotei 13 (5ème division)', 'Bankai', 'Capitaine', 'Arc de l'' Invasion des Arrancars', 'assets/img/shinji'),
